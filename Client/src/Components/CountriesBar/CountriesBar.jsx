    ...
    <div>
      <div className="rounded-xl mt-5 md:mt-10 md:mb-5 py-10 px-5">
        <h1 className="text-2xl md:text-3xl font-bold text-center">
          Southeast Asian Countries ({countriesInfo ? countriesInfo.length : 0})
        </h1>
                ...
                <div className="card bg-base-100 shadow-2xl hover:scale-105 border w-auto h-full cursor-pointer">
                  ...
                  <div className="px-7 py-5">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div>
                        <strong>Visitors:</strong> {country.countryVisitors}
                      </div>
                    </div>
                    <div className="mt-1">
                      <strong className="text-center ">Spots:</strong>
                      <hr className="border-gray-400 my-1 border-dashed" />

                      <div className="text-start">
                        {country.countrySpots &&
                          country.countrySpots.map((spot, index) => (
