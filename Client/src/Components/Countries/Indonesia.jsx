...
const Indonesia = () => {
  ...
  const indonesiaSpots = spots.filter(
    (spot) => spot.countryName.toLowerCase() === "indonesia"
  );
  ...
  return (
    <div className="my-10">
      <h1 className="text-3xl font-bold text-center mb-7">Indonesia{`'`}s Tourist Spots</h1>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {indonesiaSpots.map((spot) => (
